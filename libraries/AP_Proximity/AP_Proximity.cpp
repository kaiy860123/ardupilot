...
const AP_Param::GroupInfo AP_Proximity::var_info[] = {
    ...
    // @Values: 0:None,7:LightwareSF40c,1:LightWareSF40C-legacy,2:MAVLink,3:TeraRangerTower,4:RangeFinder,5:RPLidarA2,6:TeraRangerTowerEvo,8:LightwareSF45B,9:RPLidarS1,10:SITL,11:MorseSITL,12:AirSimSITL
    // @RebootRequired: True
    // @User: Standard
